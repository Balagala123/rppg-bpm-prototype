...
#**Latency**
The total latency for processing my test 60-second video is 6.78 seconds. The system runs faster than the actual video duration, making it efficient and suitable for real-time processing.
